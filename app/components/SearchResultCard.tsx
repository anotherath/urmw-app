...
export default function SearchResultCard({
  ...
  return (
    <div className="bg-(--card-bg) border border-(--card-border) flex items-center p-3 rounded-[24px] gap-4 shadow-[0_2px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-500 group active:scale-[0.98] lg:p-4 lg:gap-5">
      {/* Thumbnail */}
      ...
      <div className="flex-1 min-w-0 pr-1">
        <h3 className="font-semibold text-[15px] truncate mb-0.5 lg:text-base">
          {title}
        </h3>
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] text-gray-400 dark:text-gray-500 font-medium shrink-0 lg:text-sm">
            {duration}
          </span>
        </div>
      </div>
      ...
      <button
        ...
        className={cn(
          "shrink-0 w-10 h-10 flex items-center justify-center rounded-full transition-all duration-300 lg:w-11 lg:h-11",
          isDownloaded
